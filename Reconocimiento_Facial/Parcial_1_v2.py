...
ruta_imagen_conocida = "/home/daniel/Documentos/Vision_por_Computador/Reconocimiento_Facial/basededatos/Daniel_Calderon.jpg"
imagen_conocida = face_recognition.load_image_file(ruta_imagen_conocida)
codificacion_rostro_conocido = face_recognition.face_encodings(imagen_conocida)
...
ruta_carpeta = "/home/daniel/Documentos/Vision_por_Computador/Reconocimiento_Facial/basededatos"  # Actualiza con la ruta de tu carpeta
...
for filename in os.listdir(ruta_carpeta):
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        codificaciones_rostro = face_recognition.face_encodings(imagen)
...
while True:
    ...
    ubicaciones_rostros = face_recognition.face_locations(frame, model="small")
    ...
    if ubicaciones_rostros:
        for loc in ubicaciones_rostros:
            ...
            cv2.putText(frame, nombre, (left, bottom + 20), cv2.FONT_HERSHEY_DUPLEX, 0.8, (255, 255, 255), 1)
